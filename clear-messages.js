...
bot.on('message', async (message) => {
    ...
    if (!message.channel.permissionsFor(message.author).hasPermission("MANAGE_MESSAGES"))
      return message.channel.send("Sorry, you don't have the permission to execute the command \""+CLEAR_MESSAGES+"\"");
    else if (!message.channel.permissionsFor(bot.user).hasPermission("MANAGE_MESSAGES"))
      return message.channel.send("Sorry, I don't have the permission to execute the command \""+CLEAR_MESSAGES+"\"");
